...
//TODO: fix awesome_notification for iosß
...
class NotificationService {
  ...
  static Future<void> onActionReceivedMethod(
    ...
    if (payload["navigate"] == "true") {
      EIRMApp.navigatorKey.currentState?.push(
        MaterialPageRoute(
          builder: (_) => CalendarRoute(),
        ),
      );
      // Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => CalendarDayRoute(DateTime.now().day)));
    }
  }
  ...
  static Future<void> showNotification({
    ...
    assert(!scheduled || (scheduled != null));
